//This is the javascript code for index.html page
// The color changes when the button is clicked
function change()
{
...
function stopWatch() {
    if (timer) {
        ...
        if (second == 60) {
         /* increment the minutes(min) counter by ‘+1’ */
            minute++;
            second = 0;
        }
  
        if (minute == 60) {
      /* increment the hours(hr) counter by ‘+1’ */
            hour++;
            minute = 0;
            second = 0;
        }
